...
You must have completed Module 1 or have an exisiting instance of Copilot For Security installed. If you do not have a working instance of Copilot for Security please click [click here to complete Module 1](Module-1-Setting-up-the-the-environment.md#module-1---setting-up-the-environment).
